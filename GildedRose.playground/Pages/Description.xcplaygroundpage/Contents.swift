...
/*:
 ...
 Blame for this Swift playground must be assigned to [@jdortiz](https://twitter.com/jdortiz) and the repository can be found at [https://github.com/jdortiz/GildedRoseSwift](https://github.com/jdortiz/GildedRoseSwift)
 */
//: [Previous](@previous) - [Table of Contents](Table%20of%20Contents) - [Next](@next)
